    ...
    <div class="pl-56 flex flex-col min-h-screen">
      ...
      <main class="flex-1 w-full px-8 py-6 space-y-5">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div class="flex items-center gap-2.5">
              <h1 class="font-brand text-xl font-semibold text-slate-900 tracking-tight">Departmental Leadership</h1>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <div class="bg-white border border-slate-200/90 rounded-xl p-5 shadow-2xs hover:shadow-xs transition-shadow">
            <div class="flex items-center justify-between text-slate-400 mb-2">
              <span class="text-xs font-bold uppercase tracking-wider text-slate-500">Clinicians On-Duty</span>
              <div class="w-8 h-8 rounded-lg bg-slate-100 text-slate-500 flex items-center justify-center">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p class="text-2xl font-bold text-slate-900 font-mono">{{ metrics.onDutyStaffCount }}</p>
            <p class="text-[11px] text-slate-400 mt-1">of {{ metrics.totalAssignedStaff }} total assigned</p>
          </div>

          <!-- Card 4: Today's Clinic Queue -->
          <div class="bg-white border border-slate-200/90 rounded-xl p-5 shadow-2xs hover:shadow-xs transition-shadow">
            <div class="flex items-center justify-between text-slate-400 mb-2">
              <span class="text-xs font-bold uppercase tracking-wider text-slate-500">Clinic Queue</span>
              <div class="w-8 h-8 rounded-lg bg-slate-100 text-slate-500 flex items-center justify-center">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
            ...
            <p class="text-2xl font-bold text-slate-900 font-mono">{{ metrics.todayAppointmentsCount }}</p>
            <p class="text-[11px] text-slate-400 mt-1">Consultation slots today</p>
          </div>

          <!-- Card 5: Active Security Alerts -->
          <div class="bg-white border border-slate-200/90 rounded-xl p-5 shadow-2xs hover:shadow-xs transition-shadow">
            <div class="flex items-center justify-between text-slate-400 mb-2">
              <span class="text-xs font-bold uppercase tracking-wider text-slate-500">Security Alerts</span>
              <div class="w-8 h-8 rounded-lg bg-slate-100 text-slate-500 flex items-center justify-center">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p class="text-2xl font-bold text-slate-900 font-mono">{{ metrics.activeSecurityAlertsCount }}</p>
            <p class="text-[11px] text-slate-400 mt-1">Requiring supervisor review</p>
          </div>
        </div>
