    ...
    <div class="pl-56 flex flex-col min-h-screen">
      ...
      <main class="flex-1 w-full px-8 py-6 space-y-5">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 class="font-brand text-xl font-semibold text-slate-900 tracking-tight">Hospital Patients Directory</h1>
            <p class="text-xs text-slate-500 mt-1 font-medium">Demographic census and bed assignments across all registered hospital wards</p>
          </div>
        ...
        <div class="bg-white border border-slate-200 rounded-xl p-5 shadow-2xs flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div class="relative w-full md:w-80">
            ...
            <input
              ...
              class="w-full bg-slate-50 border border-slate-200 rounded-xl pl-10 pr-4 py-2.5 text-xs text-slate-900 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all font-mono"
            />
          </div>

          <!-- Ward Filter & Census Summary -->
