<template>
  <div class="space-y-5">
    ...
    >
      <div class="bg-white rounded-2xl sm:rounded-3xl max-w-2xl w-full p-5 sm:p-8 shadow-2xl border border-slate-200 relative max-h-[90vh] overflow-y-auto my-6 sm:my-8" role="dialog" aria-modal="true">
        <button
          type="button"
