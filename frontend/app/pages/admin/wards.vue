        ...
        <div class="bg-white border border-slate-200 rounded-xl p-5 shadow-2xs flex items-center justify-between gap-4">
          <div class="relative w-full max-w-md">
            ...
            <input
              ...
              class="w-full bg-slate-50 border border-slate-200 rounded-xl pl-10 pr-4 py-2.5 text-xs text-slate-900 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all"
            />
          </div>

          <span class="text-xs font-bold text-slate-500 font-mono">
            {{ filteredWards.length }} Hospital Wards Configured
          </span>
        </div>
